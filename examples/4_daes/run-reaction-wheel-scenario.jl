...
module Example4DifferentialAlgebraicEquations

using Overdot # Bring in the top-level sim environment.
using Plots # For plotting
import HDF5 # For loading the log file
using Printf # Instead of using the Juno waitbar, we'll just print for this example.

# Create the hierarchy of objects used by the sim.
scenario = setup("reaction-wheel.yaml")
