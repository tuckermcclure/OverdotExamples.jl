...
# Include a module that's not part of Overdot itself. Anything we "use"
# here will be visible during the setup portion of the scenario. So we can
# "setup" things that Overdot doesn't explicitly know about. In this example,
# this file includes a StarTrackerAndGyroController, which our scenario YAML
# file calls for.
include("Example2CustomSoftware.jl")
using .Example2CustomSoftware
