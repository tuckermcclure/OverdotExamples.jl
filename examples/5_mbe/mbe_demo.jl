...
# ```
# $ julia
# julia> using OverdotExamples
# julia> cd(joinpath(dirname(pathof(OverdotExamples)), "examples", "5_mbe"))
...
using LinearAlgebra # For interpreting commands in the scenario YAML file
